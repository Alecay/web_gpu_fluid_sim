...
@group(0) @binding(3)   var<uniform>             uSim                        : SimParams; 

@group(0) @binding(4)   var<storage, read_write> currentCells                : array<CellData>;
@group(0) @binding(5)   var<storage, read_write> nextCells                   : array<CellData>;

@group(0) @binding(6)   var<storage, read>       terrainColors               : array<vec4f>;
@group(0) @binding(7)   var<storage, read_write> outputTex                   : array<u32>;
...
@group(0) @binding(10)  var<storage, read>        sprites                     : array<SpriteData>;
